                    ...
                    <section className="headphones">
                        <div className="mark2">
                            ...
                            <div className="text">
                                ...
                                <LinkSeeProduct
                                    ...
                                    onClick={() =>
                                        handleClickLink(
                                            nameProducts.xx99markiiheadphones
                                        )
                                    }
                        ...
                        <div className="mark1">
                            <div className="text">
                                ...
                                <p>
                                    As the gold standard for headphones, the
                                    classic XX99 Mark I offers detailed and
                                    accurate audio reproduction for audiophiles,
                                    mixing engineers, and music aficionados
                                ...
                                <LinkSeeProduct
                                    ...
                                    onClick={() =>
                                        handleClickLink(
                                            nameProducts.xx99markiheadphones
                                        )
                                    }
                                    backgroundcolor="#D87D4A"
                                    hoverbackground="#FBAF85"
                        ...
                        <div className="xx59">
                            ...
                            <div className="text">
                                ...
                                <p>
                                    Enjoy your audio almost anywhere and
                                    customize it to your specific tastes with
