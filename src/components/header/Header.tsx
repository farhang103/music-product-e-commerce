        ...
        <HeaderStyled>
                    ...
                    <nav aria-label="main">
                        ...
                        <ul className="list-desktop">
                            <li>
                                <Link
                                    href="/"
                                    aria-label="Home page - audiophile"
                                >
                                    home
                                </Link>
                            </li>
                            <li>
                                <Link
                                    href="/Headphones"
                                    aria-label="Headphones page - audiophile"
                                >
                                    headphones
                                </Link>
                            </li>
                            <li>
                                <Link
                                    href="/Speakers"
                                    aria-label="Speakers page - audiophile"
                                >
                                    speakers
                                </Link>
                            </li>
                            <li>
                                <Link
                                    href="/Earphones"
                                    aria-label="Earphones page - audiophile"
                                >
                                    earphones
                                </Link>
                            </li>
            ...
            {menuOpen ? (
                <>
                    <div
                        className={
                            menuOpen ? "list-mobile open" : "list-mobile"
                        }
                    >
